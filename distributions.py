...
class RingDataset(Dataset):
    ...
    def _generate_ring_points(self):
        ...
        r_squared = torch.rand(self.num_samples) * (self.r_max**2 - self.r_min**2) + self.r_min**2
...
class TwoPeaksDataset(Dataset):
    ...
    def _generate_two_peaks_points(self):
        ...
        points_2 = self._generate_gaussian_points(self.centers[1], self.num_samples - samples_per_peak)
